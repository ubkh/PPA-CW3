...
public class Goat extends Prey {
    ...
    public Goat(int foodValue, int foodLevel, boolean randomAge, Field field, Location location) {
    ...
    protected Organism createNewOrganism(Field field, Location location) {
        return new Goat(DEFAULT_FOOD_VALUE, DEFAULT_FOOD_LEVEL, true, field, location);
    }
